...
export declare type Handler<T = any> = (event?: T) => T | any;
export declare type EventHandlerList = Array<Handler>;
export declare type EventHandlerMap = Map<EventType, EventHandlerList>;
export declare type Method = "get" | "GET" | "delete" | "DELETE" | "head" | "HEAD" | "options" | "OPTIONS" | "post" | "POST" | "put" | "PUT" | "patch" | "PATCH" | "purge" | "PURGE";
...
export declare type FirstResult = {
    firstResult: any;
    totalTime: number;
};
...
export interface FirmAjaxStatic {
    ...
    use<K extends keyof EventTargetEventMap, R = any>(type: K, handler: EventTargetEventMap<R>[K]): void;
    ...
    patch<T = any>(url: string, data?: any, config?: XhrRequestConfig): Promise<T>;
}
export {};
